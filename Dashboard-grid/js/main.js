...
function readTemp() {
  fetch("./jsonInput.json")
    ...
    .then((data) => {
      ...
      document.getElementById("binnen-temp").innerText =
        "BinnenTemp: " + Math.round(data.Temperature) + " °C";
      document.getElementById("vochtigheid").innerText =
        "Vochtigheid: " + Math.round(data.Humidity) + " %";
      document.getElementById("heatIndex").innerText =
        "Heat Index: " + Math.round(data.HeatIndex) + " %";
      document.getElementById("Licht").innerText =
